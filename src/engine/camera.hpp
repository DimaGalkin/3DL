    ...
    */
    class Camera {
        public:
            ...
            Camera(const vec3& position, const vec3& rotation, float fov);
            Camera() = delete;
            ...
            */
            void tilt(float delta); // tilt is rotation around the y axis
            void pan(float delta); // pan is rotation around the x axis
            void roll(float delta); // roll is rotation around the z axis
    ...
    */
    class CameraController {
        public:
		    ...
		    CameraController(const vec3& position, const vec3& rotation, float fov);
